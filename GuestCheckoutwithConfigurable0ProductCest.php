...
class GuestCheckoutwithConfigurable0ProductCest
{
    public function _before(AcceptanceTester $I)
    {
         $I->maximizeWindow();
         $I->amOnPage('/catalog/product/view/id/3377/s/feathers-cocktail-napkin-set-of/category/540/'); // on product detail page
         $I->wait(5);
         $I->see('Welcome');
         $I->click('//*[@id="newsletter-popup"]/div/div/div[1]/button');
         $I->wait(5);
         $I->click('//*[@id="maincontent"]/div[2]/div/div[3]/div[5]/ul/li[3]/div/div[2]');
         $I->wait(5);
         $I->click('//*[@id="maincontent"]/div[2]/div/div[3]/div[5]/ul/li[3]/div/div[4]/div/div[2]');
         $I->see('ADD TO CART');
