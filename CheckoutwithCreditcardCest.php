...
class CheckoutwithCreditcardCest
{
    ...
    {
         $I->amOnPage('/all-products/home-decor/teatowels/fox-love-tea-towel');
         // $I->see('ADD TO CART');
         $I->wait(5);
         ...
         $I->wait(5);
         $I->click('//*[@id="label_method_cntstandard_codecntcarrier"]'); //Shipping method
         $I->wait(5);
         $I->click('//*[@id="shipping-method-buttons-container"]/div/button');
         $I->wait(5);
         $I->click('//*[@id="checkout-payment-method-load"]/div/div[3]/div[1]/label/span'); //select payment method
         $I->wait(5);
