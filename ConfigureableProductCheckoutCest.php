...
class ConfigureableProductCheckoutCest
{
    ...
    {
         $I->amOnPage('/catalog/product/view/id/3242/s/cacti-border-yardage/category/535/');
         $I->wait(5);
         $I->click('//*[@id="maincontent"]/div[2]/div/div[3]/div[3]/ul/li[2]/div/div[2]');
         $I->see('ADD TO CART');
         ...
         $I->scrollTo(['css'=>'.checkout-container'],5,80);
         $I->wait(10);
