...
//first run create new order testcase
...
class EditUpdateOrderCest
{
    ...
    public function _after(AcceptanceTester $I)
    {
         ...
         $I->wait(5);
         $I->click('//*[@id="maincontent"]/div[2]/div[3]/div[7]/div/div[2]/table/tbody/tr[9]/td[5]/a'); //make an order active
         ...
         $I->wait(5);
         $I->click('//*[@id="maincontent"]/div[2]/div[3]/div[7]/div/div[2]/table/tbody/tr[9]/td[6]/a');//edit button
         $I->wait(5);
