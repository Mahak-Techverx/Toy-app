...
class RegisterGuestAndCheckoutCest
{
    public function _before(AcceptanceTester $I)
    {
        $I->maximizeWindow();
         $I->amOnPage('/all-products/featured-items/fall-for-feathers/feather-fan-dinner-napkin');
         $I->see('Welcome');
         ...
         $I->wait(25);
         $I->click('//*[@id="user-account-signup"]/div/div[1]/input'); //click checkout as guest 
         $I->wait(2);
         $I->click('//*[@id="user-account-signup"]/div/div[3]/button/span');//click continue 
         $I->see('EMAIL ADDRESS');
         $I->fillField('input#customer-email.input-text.valid.new-customer-email','test33@gmail.com');// add email 
